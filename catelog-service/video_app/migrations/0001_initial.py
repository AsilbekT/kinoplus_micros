...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video_type', models.CharField(choices=[('MOVIE', 'Movie'), ('MOVIE_TRAILER', 'Movie Trailer'), ('SERIES', 'Series'), ('SERIES_TRAILER', 'Series Trailer'), ('EPISODE', 'Episode')], max_length=20, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('widescreen_thumbnail_image', models.ImageField(blank=True, null=True, upload_to='widescreen_thumbnail_image/', validators=[video_app.utils.validate_file_size, video_app.utils.validate_image_file])),
                ('trailer_url', models.URLField(blank=True, null=True)),
                ('is_ready', models.BooleanField(default=False)),
                ('is_premiere', models.BooleanField(default=False)),
                ('has_trailer', models.BooleanField(default=False)),
                ('is_free', models.BooleanField(default=False)),
                ('telegram_private_channel', models.CharField(default='-1001802351887', max_length=200)),
                ...
                ('genre', models.ManyToManyField(blank=True, related_name='%(class)s_contents', to='video_app.genre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_contents', to='video_app.director')),
                ('external_content', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movie', to='video_app.externalcontent')),
                ('genre', models.ManyToManyField(blank=True, related_name='%(class)s_contents', to='video_app.genre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255)),
                ('duration_minute', models.IntegerField()),
                ('thumbnail_image_url', models.ImageField(blank=True, null=True, upload_to='episode_thumbnail_image/', validators=[video_app.utils.validate_file_size, video_app.utils.validate_image_file])),
                ('episode_content_url', models.URLField(blank=True, null=True)),
                ('is_ready', models.BooleanField(default=False)),
                ('conversion_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='episodes', to='video_app.videoconversiontype')),
                ('external_content', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='episode', to='video_app.externalcontent')),
